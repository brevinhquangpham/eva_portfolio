            ...
            <div className="flex flex-col-reverse md:flex-row justify-between">
                <div className='md:flex-grow md:w-[45%] md:pl-16 md:pt-24 md:space-y-4'>
                    ...
                    style={{ fontSize: '5.5rem' }}>
                        ...
                        <p className="font-raleway text-2xl text-body_text leading-normal tracking-wider" style={{ maxWidth: '41rem' }}> I'm a creative designer pursuing videogame asset or UI design. Currently I’m finishing my degree in Interdisciplinary Computing and the Arts with a minor in Congitive Science at UC San Diego. 
                        </p>
                    </div>
                </div>
            ...
            <div className="mx-auto flex justify-center items-center">
                <div>
                    <div className="flex flex-col items-center justify-center gap-2 h-60 ">
                        ...
                        alt="yo" 
                        className="w-12 h-12 animate-bounce mt-4
                        " 
                        />
                    </div>
                </div>
