...
function HomePage() {
    ...
    <img 
        ...
        alt="Eva S. Intoci" 
        className="w-64 h-120 object-cover border-2 border-gray-400"
    />
...
/>
            ...
            <Project videoSrc="/images/video fin.mov"  headerText="Sandwich Simulator" date="March 2024" bodyText="A sandwich making simulator created using P5js. " />
            <div className="flex justify-center mt-4 mb-12">
