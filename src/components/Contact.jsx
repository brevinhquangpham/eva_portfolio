...
function ContactLine({ text }) {
    return (
        <p className="font-raleway font-body_text text-l">{text}</p>
    )
}
    ...
    return (
        <div className="flex justify-center w-full">
            <div className="w-full">
                ...
                <Line length="96%" color="#82A3FF"></Line>

                </div>
                <h1 className="pl-[6%] text-3xl font-cram font-medium text-headers mb-2">
                    Contact
                </h1>
                <div className="flex justify-between mb-2">
                    <div className="pl-[6%]">
                    <p className="font-raleway font-semibold text-l">Email:</p>
